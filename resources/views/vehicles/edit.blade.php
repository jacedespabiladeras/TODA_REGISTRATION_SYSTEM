    ...
    <div id="mainWrapper" class="main-wrapper">
        ...
        <header class="topbar">
            <div class="d-flex align-items-center gap-3">
                ...
                <h1 class="page-title">Edit Vehicle Profile</h1>
            </div>
            <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-bottom p-4">
                                ...
                                <p class="text-muted small mb-0 mt-1">Make changes to vehicle details or update assigned operators/drivers below.</p>
                            </div>
                            
                            <form method="POST" action="{{ route('vehicles.update', $vehicle->id) }}" class="card-body p-4">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <label_for="color" class="form-label">Color</label>
                                            <input 
                                                type="text" 
                                                name="color" 
                                                id="color"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input 
                                                ...
                                                value="{{ old('motor_number', $vehicle->motor_number) }}"
                                            >
                                            @error('motor_number')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input 
                                                ...
                                                value="{{ old('registration_expiration', $vehicle->registration_expiration) }}"
                                            >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            >
                                                ...
                                                @foreach($operators as $operator)
                                                    <option value="{{ $operator->id }}" {{ old('operator_id', $vehicle->operator_id) == $operator->id ? 'selected' : '' }}>
